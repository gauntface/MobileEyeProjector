...
class PreferencesMobileeyeprojectoruiDialog(gtk.Dialog):
    __gtype_name__ = "PreferencesMobileeyeprojectoruiDialog"
    prefernces = {}

    def __init__(self):
        """__init__ - This function is typically not called directly.
        Creation of a PreferencesMobileeyeprojectoruiDialog requires redeading the associated ui
        file and parsing the ui definition extrenally,
        and then calling PreferencesMobileeyeprojectoruiDialog.finish_initializing().

        Use the convenience function NewPreferencesMobileeyeprojectoruiDialog to create
    ...
    def finish_initializing(self, builder):
        ...
        self.__db_name = "mobileeyeprojectorui"
        self.__database = CouchDatabase(self.__db_name, create=True)
        self.__preferences = None
        self.__key = None

        #set the record type and then initalize the preferences
        self.__record_type = "http://wiki.ubuntu.com/Quickly/RecordTypes/Mobileeyeprojectorui/Preferences"
    ...
    def get_preferences(self):
        ...
        preferences for mobileeyeprojectorui. Creates a couchdb record if
        necessary.
        """
...
def NewPreferencesMobileeyeprojectoruiDialog():
    """NewPreferencesMobileeyeprojectoruiDialog - returns a fully instantiated
    PreferencesMobileeyeprojectoruiDialog object. Use this function rather than
    creating a PreferencesMobileeyeprojectoruiDialog instance directly.
    """

    #look for the ui file that describes the ui
    ui_filename = os.path.join(getdatapath(), 'ui', 'PreferencesMobileeyeprojectoruiDialog.ui')
    if not os.path.exists(ui_filename):
        ui_filename = None

    builder = gtk.Builder()
    builder.add_from_file(ui_filename)
    dialog = builder.get_object("preferences_mobileeyeprojectorui_dialog")
    dialog.finish_initializing(builder)
    return dialog

if __name__ == "__main__":
    dialog = NewPreferencesMobileeyeprojectoruiDialog()
    dialog.show()
    gtk.main()
