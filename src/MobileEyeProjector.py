...
import sys, BluetoothThread, Queue, gobject
try:
    import pygtk
    pygtk.require("2.0")
except:
...
class MobileEyeUI:
    ...
    def __init__(self):
        ...
        self.toBluetoothQ = Queue.Queue()
        self.fromBluetoothQ = Queue.Queue()
        
        self.bluetoothThread = BluetoothThread.BluetoothThread(self.update_bluetooth_label, self.toBluetoothQ, self.fromBluetoothQ)
